...
HD_PWD='D:/projectvivado/morse_code/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_encoder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source morse_encoder.tcl
