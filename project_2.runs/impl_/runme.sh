...
HD_PWD='D:/projectvivado/morse_code/project_2/project_2.runs/impl_'
cd "$HD_PWD"
...
EAStep vivado -log morse_encoder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source morse_encoder.tcl -notrace
